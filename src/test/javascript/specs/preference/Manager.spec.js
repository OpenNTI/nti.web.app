...
describe('Preference Manager Tests', function() {
	...
	describe('-', function() {
		...
		beforeEach(function() {
			var simConfig = {};
			PreferenceManager = NextThought.preference.Manager.create({href: '/dataserver/++preferences++'});
			...
			Ext.ux.ajax.SimManager.register(simConfig);
		});
	...
	afterEach(function() {
		//Ext.data.Connection.prototype.openRequest = Ext.ux.ajax.SimManager._openRequest;
	});
});
