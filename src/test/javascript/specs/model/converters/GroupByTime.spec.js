...
describe("GroupByTime Tests", function() {
	...
	describe('Sortable Grouping String Tests', function(){
		...
		it('Sorts correctly within a week', function(){
		   ...
		   expect(result.groups).toEqual(["C213180000 Saturday", "C299580000 Friday", "C385980000 Thursday", "C472380000 Wednesday"]);
		...
		it('Sorts correctly across year boundry', function(){
		  var current = new Date('January 3, 2013 11:13:00'),
		   ...
		   expect(result.groups).toEqual(["C213180000 Tuesday", "C299580000 Monday", "C385980000 Sunday", "C472380000 Saturday"]);
		...
		it('Works for all groupings', function(){
		   ...
		   expect(result.groups).toEqual(["B Yesterday", "C213180000 Tuesday", "C299580000 Monday", "C385980000 Sunday", "C472380000 Saturday", "C558780000 Friday", "D Last week", "E 2 weeks ago", "F 3 weeks ago", "G Last month", "H Last year", "I Older"]);
