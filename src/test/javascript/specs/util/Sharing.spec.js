describe('Sharing Utils', function() {
	...
	beforeEach(function() {
		TestSharingUtils = Object.create(NextThought.util.Sharing);
		globalAppUserFunc = TestSharingUtils.getAppUserCommunities;
		TestSharingUtils.getAppUserCommunities = function() { return communities; };
		//I'm not sure this test suite tests anything :( Everything passes now that this function doesn't throw.
		TestSharingUtils.getCurrentSharingInfo = function() {
			return {
