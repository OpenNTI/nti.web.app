		...
		describe('Pricing response', function() {
			...
			describe('success conditions', function() {
				it('calls success with pricing info model', function() {
					...
					resp.responseText = '{"Amount": 90000.0, "Class": "StripePricedPurchasable", "Coupon": null, "Currency": "USD", ' +
										'"MimeType": "application/vnd.nextthought.stripepricedpurchasable", ' +
										'"NTIID": "tag:nextthought.com,2011-10:PRMIA-HTML-PRMIA_RiskCourse.advanced_stress_testing_for_financial_institutions", ' +
										'"Provider": "NTI-TEST", "PurchasePrice": 90000.0, "Quantity": 1}';
					fakeServer = mockDoPricingRequest({}, true, resp);
