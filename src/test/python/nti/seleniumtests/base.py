...
class WebAppTestBase(unittest.TestCase):
	...
	def _login(self, user, password):
		...
		wait_for_element(driver = self.driver, tag = 'input', attribute = 'id', attribute_value = 'username')
		self.driver.find_element_by_id ('username').send_keys(user)
		wait_for_element(driver = self.driver, tag = 'input', attribute = 'id', attribute_value = 'password')
