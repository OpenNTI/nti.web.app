import NewSkin_helper_login as module
...
class Test_page(unittest.TestCase):
    ...
    def test_facebook_google_login(self):
        ...
        self.assertTrue(self.module.find_alternate_login('google'))
    ...
    def test_URLS(self):
        ...
        self.assertEqual(self.module.find_title(), 'NextThought - Connecting People. Learning Together.')
