Ext.define('NextThought.util.Anchors', {
			   ...
			   preresolveLocatorInfo: function (contentRangeDescriptions, docElement, cleanRoot, containers, docElementContainerId) {
				   ...
				   console[locatorsFound === contentRangeDescriptions.length ? 'log'
						   : 'warn']('Preresolved ' + locatorsFound + '/' + contentRangeDescriptions.length + ' range descriptions');
			   },
			   ...
			   scopedContainerNode:           function (fragOrNode, containerId, rootId) {
				   ...
				   if (!containerId) {
					   ...
					   searchWithin = (rootId !== containerId) ? Anchors.getContainerNode(containerId, node, null)
							   : node;
				   }
...
//		console.log('liveStartResult', liveStartResult, 'liveEndResult', liveEndResult);
			   ...
			   purifyRange:                                 function (range, doc) {
				   ...
				   Anchors.tagNode(origEndEdgeNode, 'end', (origStartEdgeNode === origEndEdgeNode)
						   ? origEndModifiedOff + 33 : origEndModifiedOff);
