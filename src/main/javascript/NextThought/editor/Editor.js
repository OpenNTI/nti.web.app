Ext.define('NextThought.editor.AbstractEditor',{
	...
	setupSharedListEl: function(me, tabTracker, scrollParentEl) {
		...
		if(me.sharedListEl){
			if($AppConfig.service.canShare()){
				...
				this.mon(me.sharedList,'cancel-indicated', function(){this.fireEvent('cancel');}, me);
				this.mon(me.sharedList,'sync-height', function(){this.maybeResizeContentBox();}, me);
			}else{
	...
	isActive: function(){ return this.el.hasCls('active'); },
