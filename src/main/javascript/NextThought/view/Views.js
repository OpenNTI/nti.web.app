Ext.define('NextThought.view.Views', {
	...
	items: [
		{id: 'profile', xtype: 'profile-view-container', associatedParent: 'contacts', forceScrollZoneOut: true},
		{id: 'library', xtype: 'library-view-container', forceScrollZoneOut: true},
