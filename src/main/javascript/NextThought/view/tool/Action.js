Ext.define('NextThought.view.tool.Action',{
	...
	renderTpl: Ext.DomHelper.markup([{cls: 'icon {iconCls}'},{cls:'label', html:'{label}'}]),
	...
	afterRender: function(){
		...
		el.hover(function(){el.addCls(c);},function(){el.removeCls(c);});
	},


	click: function(e,dom){
		function stop(){e.stopEvent(); return false;}
