Ext.define('NextThought.view.course.dashboard.View',{
	...
	requires:['NextThought.util.MasonryPacker'],
...
/* Debug code End */
	...
	constructor: function(config){
		...
		var items = config.items = Ext.clone(this.items);
		//debug
		this.shuffle(items.items);

		this.adjustWeights(items.items);

		this.sortTiles(items.items);
