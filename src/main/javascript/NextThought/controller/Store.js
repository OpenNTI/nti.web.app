Ext.define('NextThought.controller.Store', function(){
	 ...
	 *
	 */
	var PurchaseHelper = function(purchaseDesc, tokenObject, expectedPrice, delegate, scope) {
	...
	Ext.apply(PurchaseHelper.prototype, {
	...
	return {
		...
		submitPurchase: function(cmp, purchaseDescription, tokenObject, pricingInfo) {
			...
			try {
				this.paymentProcessor = new PurchaseHelper(purchaseDescription, tokenObject, pricingInfo.get('PurchasePrice'), delegate, this);
			}
			catch (e) {
