...
export default class UserList extends React.Component {
	...
	componentDidMount() {
		...
		const userClass =
			currentTab === 'all'
				? 'user-lookup-search all-user clearfix'
				: 'user-lookup-search people clearfix';
		let isFollow = [];
				...
				<div className="container">
					<section className={userClass}>
						<div className="title-block-lookup">
							<p>People</p>
							<a className="view-all" onClick={this.viewAll}>
								View All
							</a>
						</div>
