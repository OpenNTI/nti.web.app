...
const t = scoped(
	'nti-site-admin.users.user.user-book-enrollment.Frame',
	DEFAULT_TEXT
);
		...
		return (
			<Layouts.NavContent.Container>
				<Layouts.NavContent.Nav className="nav-bar">
					{this.renderHeader()}
					<NavBar
						book={userBookRecord && userBookRecord.Bundle}
						user={userBookRecord && userBookRecord.User}
					/>
...
export default decorate(SiteAdminUserBookEnrollmentView, [
