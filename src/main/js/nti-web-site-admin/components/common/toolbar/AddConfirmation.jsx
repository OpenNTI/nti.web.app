...
const DEFAULT_TEXT = {
	confirm: 'Confirm',
	cancel: 'Cancel',
	confirmationMessageSingle:
		'Are you sure you want to give this user site admin permissions?',
	confirmationMessagePlural:
		'Are you sure you want to give these users site admin permissions?',
};
const t = scoped(
	'nti-site-admin.common.components.toolbar.addconfirmation',
	DEFAULT_TEXT
);
	...
	renderMessage() {
		const msg =
			this.props.selectedUsers.length === 1
				? t('confirmationMessageSingle')
				: t('confirmationMessagePlural');
