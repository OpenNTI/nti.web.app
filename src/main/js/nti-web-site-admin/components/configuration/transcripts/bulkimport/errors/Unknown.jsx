...
const logger = Logger.get(
	'web-site-admin.components.advanced.transcripts.bulkimport.error'
);

const t = scoped(
	'web-site-admin.components.advanced.transcripts.bulkimport.error.Unknown',
	{
...
export default class UnknownError extends React.Component {
	...
	constructor(props) {
		super(props);
		logger.warn(
			'Unrecognized transcript import error: %o',
			(props || {}).error
		);
	}
