...
const t = scoped('nti-web-app.admin.branding.Site', {
	...
	siteName: {
		title: 'Site Name',
		description:
			'This will impact automated emails, messaging, and tab name.',
	},
	domain: {
		title: 'Domain',
		description:
			'Customize the web address that learners will use to find your site. <br />To change contact <a href="mailto:support@nextthought.com">support@nextthought.com</a>',
	},
});
		...
		<Section className={cx('site-params')} title={t('title')}>
			<List.Unadorned>
				<li>
					...
					<Input.Text
						value={brandName}
						onChange={changeHandler(BRAND_NAME)}
					/>
				</li>
				<li>
					<div>
