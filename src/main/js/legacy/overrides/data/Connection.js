...
module.exports = exports = Ext.define(
	'NextThought.overrides.data.Connection',
	{
		...
		setOptions: function (options, scope) {
			var i,
				badParams = ['id', 'page', 'start', 'limit', 'group', 'sort'], //'_dc'
	...
	function () {
		...
		Ext.Ajax.defaultHeaders = {
			...
			...(typeof BUILD_PACKAGE_NAME === 'undefined'
				? {}
				: { 'X-NTI-Client-App': BUILD_PACKAGE_NAME }),
			...(typeof BUILD_PACKAGE_VERSION === 'undefined'
				? {}
				: { 'X-NTI-Client-Version': BUILD_PACKAGE_VERSION }),
		};
