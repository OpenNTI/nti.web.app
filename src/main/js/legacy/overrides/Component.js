...
module.exports = exports = Ext.define(
	'NextThought.overrides.Component',
	{
		...
		constructor: function () {
			...
			me.onceRendered = new Promise(
				function (fulfill) {
					me.afterRender = Ext.Function.createSequence(
						me.afterRender,
						fulfill
					);
				}.bind(me)
			...
			me.on('afterrender', function () {
				var maybeFireVisibilityChange = Ext.Function.createBuffered(
					this.maybeFireVisibilityChange,
					100,
					this
				);
		...
		maybeFireVisibilityChange: function () {
			...
			if (v !== this.___visibility) {
				this.fireEvent(
					'visibility-changed-' + (v ? 'visible' : 'hidden'),
					this
				);
