...
module.exports = exports = Ext.define(
	'NextThought.app.stream.components.filters.MultiSelect',
	{
		...
		getInputs() {
			return (
				this.el &&
				this.el.dom &&
				this.el.dom.querySelectorAll('input[type=checkbox]')
			);
		},
		...
		setValue(value) {
			...
			for (let input of inputs) {
				if (input) {
					input.checked =
						value[0] === 'all' || value.indexOf(input.value) >= 0;
				}
			}
		},
