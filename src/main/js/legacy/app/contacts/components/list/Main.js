	...
	'NextThought.app.contacts.components.list.Main',
	{
				...
				items: [
					...
					},
					{
						...
						placeholder: getString(
							'NextThought.view.account.contacts.createlist.Main.name-placeholder'
						),
					},
				],
			},
				...
				items: [
					{
						...
						name: 'cancel',
						text: getString(
							'NextThought.view.account.contacts.createlist.Main.cancel'
						),
						handler: function (b) {
							b.up('window').close();
						},
					},
					{
						...
						name: 'submit',
						text: getString(
							'NextThought.view.account.contacts.createlist.Main.create'
						),
						disabled: true,
						minWidth: 96,
					},
		...
		showError: function (errorText) {
			...
			errorText =
				errorText ||
				getString(
					'NextThought.view.account.contacts.createlist.Main.unknown-error'
				);
