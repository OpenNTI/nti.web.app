	...
	'NextThought.app.contacts.components.group.Main',
	{
				...
				items: [
					...
					},
					{
						...
						placeholder: getString(
							'NextThought.view.account.codecreation.Main.group-name'
						),
						allowBlank: false,
					},
				],
				...
				items: [
					{
						...
						hidden: true,
						html: getString(
							'NextThought.view.account.codecreation.Main.group-code'
						),
					},
				...
				items: [
					{
						...
						name: 'cancel',
						text: getString(
							'NextThought.view.account.codecreation.Main.cancel'
						),
						handler: function (b) {
							b.up('window').close();
						},
					},
					{
						...
						name: 'submit',
						text: getString(
							'NextThought.view.account.codecreation.Main.create'
						),
						disabled: true,
						minWidth: 96,
					},
		...
		showError: function (errorText) {
			...
			errorText =
				errorText ||
				getString(
					'NextThought.view.account.codecreation.Main.unknown-error'
				);
