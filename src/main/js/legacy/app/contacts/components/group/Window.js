	...
	'NextThought.app.contacts.components.group.Window',
	{
				...
				items: [
					{
						...
						noIcon: true,
						title: getString(
							'NextThought.view.account.codecreation.Window.title'
						),
						detail: getString(
							'NextThought.view.account.codecreation.Window.detail'
						),
					},
		...
		showCreatedGroupCode: function (code) {
			...
			headerView.updateHeaderText(
				getString(
					'NextThought.view.account.codecreation.Window.created-title'
				),
				getString(
					'NextThought.view.account.codecreation.Window.created-detail'
				)
			);
