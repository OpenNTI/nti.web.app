			...
			{ cls: 'outline-list' },
			{
				...
				cn: {
					...
					cn: [
						...
						{
							tag: 'tpl',
							if: 'isContact && suggestedContactsLabel',
							cn: [
								{
								...
								{
									cls: 'contact-button suggest',
									html: '{suggestedContactsLabel}',
								},
							],
						},
						{
		...
		beforeRender: function () {
			...
			this.renderData = Ext.apply(this.renderData || {}, {
				...
				cancreate:
					...
					(this.subType !== 'group' ||
						Service.canCreateDynamicGroups()),
			...
			this.on({
				...
				beforeselect: function (sel, r) {
					var pass = r.data.type !== 'unit',
						store = sel.getStore(),
						last = sel.lastSelected || store.first(),
						next;
