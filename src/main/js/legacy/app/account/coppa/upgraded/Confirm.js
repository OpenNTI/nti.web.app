...
module.exports = exports = Ext.define(
	'NextThought.app.account.coppa.upgraded.Confirm',
	{
		...
		renderTpl: Ext.DomHelper.markup([
			...
			{
				cls: 'coppa-main-view account-info',
				cn: [
						...
						cn: [
							...
							},
							{
								...
								cn: [
									...
									},
									{
										tag: 'span',
										cls: 'validation-message',
										html: "What's your email address?",
									},
								],
							},
							{
								cls: 'contact_email hidden',
								cn: [
									{
										tag: 'input',
										type: 'text',
...

							{
								...
								cn: [
									...
									{
										cls: 'what-school',
										html: 'What school do you attend?',
									},
					...
					},
					{
						...
						cn: [
							...
							{
								cls: 'policy-link hidden',
								html: "View Child's Privacy Policy",
							},
						],
					},
				],
		...
		afterRender: function () {
			...
			this.fieldsChannel = {
				...
				contact_email: function () {
					return me.el.down('[name=contact_email]').getValue();
				},
				email: function () {
					return me.el.down('[name=email]').getValue();
				},
				opt_in_email_communication: function () {
					return me.el
						.down('input[name=opt_in_email_communication]')
						.is(':checked');
				},
				affiliation: function () {
					return me.affiliation.getValue();
				},
			};
		...
		markFields: function () {
			...
			for (key in schema) {
				if (
					...
					me.validated.hasOwnProperty(key) &&
					key !== 'birthdate'
				) {
