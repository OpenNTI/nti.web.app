	...
	'NextThought.app.account.settings.Window',
	{
		...
		constructor: function () {
			...
			if (canUploadAvatar) {
				...
				tabs.push({
					text: getString(
						'NextThought.view.account.Window.avatar-choices'
					),
			...
			tabs.push({
				text: getString('NextThought.view.account.Window.password'),
				associatedPanel: 'password-reset-form',
			});
			tabs.push({
				text: getString('NextThought.view.account.Window.preferences'),
				associatedPanel: 'account-preferences',
			});
			...
			this.items = [
				{
					...
					autoEl: {
						...
						cn: [
							...
							{
								cls: 'avatar-wrapper',
								cn: [Ext.util.Format.avatar(user)],
							},
							{
								cls: 'wrap',
								cn: [
