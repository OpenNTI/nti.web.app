...
module.exports = exports = Ext.define(
	'NextThought.app.account.emailverify.verify.Index',
	{
		...
		congratsWrapperTpl: new Ext.XTemplate(
			Ext.DomHelper.markup([
				{
					cls: 'congrats-wrapper',
					cn: [
						{
							cls: 'text',
							cn: [
		...
		pendingVerificationWrapperTpl: new Ext.XTemplate(
			Ext.DomHelper.markup([
				{
					cls: 'pending-wrapper',
					cn: [
		...
		supportEmailLinkTpl: new Ext.XTemplate(
			Ext.DomHelper.markup([
				{
					cls: 'support',
					cn: [
						...
						},
						{
							tag: 'tpl',
							if: '!email',
							cn: [{ tag: 'span', html: 'Contact support' }],
						},
						...
						cn: [
							{
								...
								cn: [
									...
									{ cls: 'sub' },
									{
										...
										cn: [
											{
												cls: 'button send-email link',
												html: 'Send another email',
											},
											{
												cls: 'button link change-email',
												html: 'Change email address',
											},
										],
									},
								],
		...
		afterRender: function () {
			...
			this.mon(
				this.gotoVerifyEl,
				'click',
				this.showVerifyCard.bind(this)
			);
			this.mon(
				this.confirmEditEl,
				'click',
				this.submitEmailClicked.bind(this)
			);
		...
		onSave: function () {
			...
			me.saveToken(tokenVal).catch(function () {
				me.showError();
			});
		},
			...
			return new Promise(function (fulfill, reject) {
				me.user.save({
					...
					failure: function (resp) {
						var msg =
							Ext.JSON.decode(resp.responseText, true) || {};
