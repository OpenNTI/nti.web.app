...
module.exports = exports = Ext.define(
	'NextThought.app.account.contacts.management.Options',
	{
		...
		items: [
			{
				text: getString(
					'NextThought.view.account.contacts.management.Options.settings-label'
				),
				cls: 'label',
				allowUncheck: false,
				header: true,
			...
			{
				text: getString(
					'NextThought.view.account.contacts.management.Options.remove'
				),
				cls: 'no-checkbox',
				removeContact: true,
				allowSelect: true,
		...
		afterRender: function () {
			this.closeEl = Ext.DomHelper.append(
				this.el,
				{ cls: 'close', html: '' },
				true
			);
