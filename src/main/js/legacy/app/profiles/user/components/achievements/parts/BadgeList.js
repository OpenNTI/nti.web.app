	...
	'NextThought.app.profiles.user.components.achievements.parts.BadgeList',
	{
					...
					cn: [
						{
							...
							cn: [
								...
								{
									tag: 'tpl',
									if: 'this.canExport(values)',
									cn: [{ cls: 'link export', html: '' }],
								},
							],
						},
					],
		...
		onItemClick: function (record, item, index, e) {
			if (e.getTarget('.export')) {
				...
				this.WindowActions.pushWindow(record, null, null, null, {
					record: record,
				});
			}
		},
