...
module.exports = exports = Ext.define(
	'NextThought.app.course.overview.components.editing.outline.outlinenode.Preview',
	{
				...
				cn: [
					{
						...
						cn: [
							{
								tag: 'tpl',
								if: 'enableCalendarControls',
								cn: [{ cls: 'calendar-container' }],
							},
						],
					},
					{
						...
						cn: [
							{
								...
								cn: [{ cls: 'edit-container' }],
							},
							{
								tag: 'tpl',
								if: 'enableEditControls',
								cn: [{ cls: 'synclock-container' }],
							},
						],
					},
				],
		...
		addSynclockControls: function () {
			...
			if (container) {
				this.syncCmp = Ext.widget(
					'overview-editing-controls-synclock',
					{
						record: this.record,
						contents: this.contents,
						renderTo: container,
