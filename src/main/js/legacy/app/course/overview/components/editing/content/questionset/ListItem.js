	...
	'NextThought.app.course.overview.components.editing.content.questionset.ListItem',
	{
		...
		statics: {
			...
			getSupported: function () {
				return [QuestionSetRef.mimeType, AssignmentRef.mimeType];
			},
		},
		...
		updateRecord: function (record) {
			...
			me.course.getAssignments().then(function (assignments) {
				me.IsAssignment = assignments.isAssignment(
		...
		setUpRecord(record) {
			...
			return this.course.getAssignments().then(assignments => {
