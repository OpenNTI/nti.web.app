...
module.exports = exports = Ext.define(
	'NextThought.app.assessment.components.editing.components.Reset',
	{
		...
		onClick() {
			const resetLink =
				this.assignment.getLink('Reset') ||
				!this.assignment.getDateEditingLink();
			...
			Service.post(resetLink).then(response => {
