										...
										doSort(state) {
											var store =
												...
												sorter = new Ext.util.Sorter({
													...
													root: 'data',
													sorterFn:
														StudentPerformance.getScoreSorter(),
												});
						...
						assignments?.map(async o => {
							...
							try {
								...
								const pendingAssessment =
									historyItem?.get('pendingAssessment');

								if (
									this.maybeSetFinalGrade(
										o,
										historyItem,
										grade
									)
