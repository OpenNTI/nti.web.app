...
module.exports = exports = Ext.define(
	'NextThought.app.course.enrollment.components.Gift',
	{
		...
		buttonCfg: [
			{
				name: getString(
					'NextThought.view.courseware.enrollment.Gift.Submit'
				),
				disabled: true,
			...
			{
				name: getString(
					'NextThought.view.courseware.enrollment.Gift.Cancel'
				),
				disabled: false,
				action: 'go-back',
				secondary: true,
		...
		form: [
			{
				name: 'gift',
				label: getString(
					'NextThought.view.courseware.enrollment.Gift.GiftInfo'
				),
				items: [
					{
						...
						inputs: [
							{
								type: 'description',
								text: getString(
									'NextThought.view.courseware.enrollment.Gift.GiftMessageOption'
								),
							},
						],
					},
						...
						inputs: [
							{
								...
								text: getString(
									'NextThought.view.courseware.enrollment.Gift.GiftNotificationTitle'
								),
							},
							{
								type: 'text',
								...
								placeholder: getString(
									'NextThought.view.courseware.enrollment.Gift.FirstName'
								),
							...
							},
							{
								...
								size: 'large left',
								placeholder: getString(
									'NextThought.view.courseware.enrollment.Gift.LastName'
								),
								focusEvent: 'enable-recipient',
							},
							{
								type: 'text',
								name: 'receiver',
								size: 'large left last',
								required: true,
								placeholder: getString(
									'NextThought.view.courseware.enrollment.Gift.GifteeEmail'
								),
								focusEvent: 'enable-recipient',
							},
						],
						...
						inputs: [
							{
								...
								name: 'message',
								placeholder: getString(
									'NextThought.view.courseware.enrollment.Gift.GiftMessagePlaceholder'
								),
								focusEvent: 'enable-recipient',
							},
						],
					},
					{
						...
						labelCls: 'gift-from',
						label: getString(
							'NextThought.view.courseware.enrollment.Gift.From'
						),
						inputs: [
							{
								type: 'text',
								...
								size: 'large',
								placeholder: getString(
									'NextThought.view.courseware.enrollment.Gift.GifterName'
								),
								focusEvent: 'enable-recipient',
								help: getString(
									'NextThought.view.courseware.enrollment.Gift.Notice'
								),
							},
						],
					},
			...
			},
			{
				name: 'payment',
				label: getString(
					'NextThought.view.courseware.enrollment.Gift.PayInfo'
				),
				items: [
					{
						xtype: 'enrollment-set',
						inputs: [
							{
								...
								required: true,
								placeholder: getString(
									'NextThought.view.courseware.enrollment.Gift.GifterEmail'
								),
								size: 'large',
								help: getString(
									'NextThought.view.courseware.enrollment.Gift.GifterPurchaseNotice'
								),
							},
						],
					},
					{
						xtype: 'enrollment-set',
						label: getString(
							'NextThought.view.courseware.enrollment.Gift.CCInfo'
						),
						inputs: [
							{
								type: 'credit-card',
					...
					},
					{
						xtype: 'enrollment-set',
						label: getString(
							'NextThought.view.courseware.enrollment.Gift.BillingInfo'
						),
						inputs: [
							{
								type: 'text',
								name: 'address_line1',
								placeholder: getString(
									'NextThought.view.courseware.enrollment.Gift.BillingAddress'
								),
								required: true,
								size: 'full',
							},
							{
								...
								name: 'address_line2',
								placeholder: getString(
									'NextThought.view.courseware.enrollment.Gift.BillingAddressOpt'
								),
								size: 'full',
							},
							...
							// {type: 'text', name: 'address_line5', hidden: true, placeholder: 'Address (optional)', size: 'full'},
							{
								...
								name: 'address_city',
								placeholder: getString(
									'NextThought.view.courseware.enrollment.Gift.CityTown'
								),
								size: 'large',
							},
							{
								...
								name: 'address_state',
								placeholder: getString(
									'NextThought.view.courseware.enrollment.Gift.StateProvTerrReg'
								),
								size: 'full',
							},
							{
								...
								placeholder: getString(
									'NextThought.view.courseware.enrollment.Gift.Country'
								),
								required: true,
								size: 'large left',
							},
							{
								...
								name: 'address_zip',
								placeholder: getString(
									'NextThought.view.courseware.enrollment.Gift.ZIPPostal'
								),
								size: 'small left',
								required: false,
							},
						...
						inputs: [
							{
								...
								doNotStore: true,
								text: getString(
									'NextThought.view.courseware.enrollment.Gift.LicenseAgree'
								),
								correct: true,
							},
						],
		...
		initComponent: function () {
			...
			me.on('enable-recipient', function () {
				var checkbox =
					me.recipientCheckbox || me.down('[name=enable_recipient]');
			...
			if (formValue['enable_recipient']) {
				...
				if (formValue.to_first_name) {
					if (formValue.to_last_name) {
						desc.to =
							formValue.to_first_name +
							' ' +
							formValue.to_last_name;
					} else {
