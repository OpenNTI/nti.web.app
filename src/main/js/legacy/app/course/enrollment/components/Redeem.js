...
module.exports = exports = Ext.define(
	'NextThought.app.course.enrollment.components.Redeem',
	{
		...
		buttonCfg: [
			{
				name: getString(
					'NextThought.view.courseware.enrollment.Redeem.Redeem'
				),
				disabled: true,
			...
			{
				name: getString(
					'NextThought.view.courseware.enrollment.Redeem.Cancel'
				),
				disabled: false,
				action: 'go-back',
				secondary: true,
		...
		form: [
			{
				name: 'gift',
				label: getString(
					'NextThought.view.courseware.enrollment.Redeem.AccessKeyRedeem'
				),
						...
						inputs: [
							{
								...
								placeholder: getString(
									'NextThought.view.courseware.enrollment.Redeem.AccessKeyInput'
								),
								required: true,
									...
									cn: [
										{
											...
											html:
												getString(
													'NextThought.view.courseware.enrollment.Redeem.HelpFindAccessKey'
												) + ' ',
										},
										getFormattedString(
						...
						inputs: [
							{
								...
								doNotStore: true,
								text: getString(
									'NextThought.view.courseware.enrollment.Redeem.LicensingAgree'
								),
								correct: true,
							},
						],
		...
		stopClose: function () {
			...
			if (this.hasMask()) {
				...
				r = new Promise(function (fulfill, reject) {
					Ext.Msg.show({
						title: getString(
							'NextThought.view.courseware.enrollment.Redeem.NotRedeemed'
						),
						msg: getString(
