...
module.exports = exports = Ext.define(
	'NextThought.app.course.enrollment.components.parts.CheckboxGroup',
	{
		...
		renderTpl: Ext.DomHelper.markup({
			cls: 'enrollment-checkbox-group',
			cn: [
				{
					cls: 'enrollment-input dark full radio yes',
					cn: [
						{
							tag: 'input',
							id: '{id}-{name}-yes',
				...
				{
					cls: 'enrollment-input dark full radio no',
					cn: [
						{
							tag: 'input',
							id: '{id}-{name}-no',
		...
		changed: function (e) {
			...
			input =
				label &&
				label.up('.enrollment-input').down('input[type=checkbox]');
