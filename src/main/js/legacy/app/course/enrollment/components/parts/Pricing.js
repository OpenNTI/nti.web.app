...
module.exports = exports = Ext.define(
	'NextThought.app.course.enrollment.components.parts.Pricing',
	{
		...
		initComponent: function () {
			...
			this.update = Ext.Function.createBuffered(
		...
		beforeRender: function () {
			...
			this.renderData = Ext.apply(this.renderData || {}, {
				...
				enrollmentType:
					this.enrollmentOption.display ||
					getString(this.enrollmentOption.displayKey),
				credit:
					hours && this.enrollmentOption.hasCredit
						? Ext.util.Format.plural(hours, 'Credit Hour')
						: '',
		...
		afterRender: function () {
			...
			if (this.couponContainerEl) {
				this.couponContainerEl.setVisibilityMode(
		...
		update: function (coupon) {
			...
			function onSuccess(result) {
				...
				if (couponDetails.PercentOff) {
					...
					discount =
						'$' +
						(couponDetails.AmountOff / 100).toFixed(2) +
						' off';
				}
			...
			if (!coupon) {
				...
				this.StoreActions.priceEnrollmentPurchase(
					this,
					desc,
					onSuccess,
					onFailure
