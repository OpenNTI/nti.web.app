...
module.exports = exports = Ext.define(
	'NextThought.app.context.components.list.Question',
	{
			...
			Ext.DomHelper.markup([
				{
					tag: 'tpl',
					if: 'root',
					cn: [{ tag: 'span', html: '{root}' }],
				},
				{ tag: 'tpl', if: 'extra', cn: [{ tag: 'span', html: '...' }] },
				{
					tag: 'tpl',
					if: 'leaf',
					cn: [{ tag: 'span', html: '{leaf}' }],
				},
			])
		),
		...
		renderTpl: Ext.DomHelper.markup([
			...
			{
				cls: 'content',
				cn: [{ cls: 'snippet text', html: '{content}' }],
			},
		]),
		...
		initComponent: function () {
			...
			this.PathActions.getPathToObject(this.record).then(
				this.setLineage.bind(this)
			);
		},
