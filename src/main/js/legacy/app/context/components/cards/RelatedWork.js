...
module.exports = exports = Ext.define(
	'NextThought.app.context.components.cards.RelatedWork',
	{
		...
		renderTpl: Ext.DomHelper.markup([
			{
				cls: 'context-image related-context content-card',
				cn: [
					{ cls: 'thumbnail' },
					{
						cls: 'meta',
		...
		setContent: function () {
			var root =
					this.course &&
					this.course.getContentRoots &&
					this.course.getContentRoots()[0],
			...
			if (type) {
				url =
					url &&
					url.indexOf(RelatedWork.FILE_FALLBACK_BLANK_IMAGE) > -1
						? null
						: url;
				Ext.widget({
					xtype: 'react',
