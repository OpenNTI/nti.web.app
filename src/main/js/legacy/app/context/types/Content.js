...
const ContentActions = require('internal/legacy/app/contentviewer/Actions');
...
const PartsSlide = require('internal/legacy/app/mediaviewer/components/reader/parts/Slide');
const Slidedeck = require('internal/legacy/app/mediaviewer/content/Slidedeck');
const SlideVideo = require('internal/legacy/app/mediaviewer/content/SlideVideo');
const ImageOverlayedPanel = require('internal/legacy/app/image/OverlayedPanel');
const RollOverlayedPanel = require('internal/legacy/app/video/roll/OverlayedPanel');
...
const OverlayedPanel = require('internal/legacy/common/components/cards/OverlayedPanel');
const Card = require('internal/legacy/common/components/cards/Card');
