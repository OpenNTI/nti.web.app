...
module.exports = exports = Ext.define(
	'NextThought.app.assessment.results.parts.Matching',
	{
		...
		statics: {
			mimeType:
				'application/vnd.nextthought.assessment.aggregatedmatchingpart',
		},
		...
		initComponent: function () {
			...
			if (results && Object.keys(results).length === 0) {
				this.add({
					...
					autoEl: {
						cls: 'message',
						html: 'This question was not answered.',
					},
				});
		...
		getResults: function () {
			...
			resultKeys.forEach(function (labelIdx) {
				...
				keys.forEach(function (valueIdx) {
					...
					newResults[valueIdx][labelIdx] =
						oldResults[labelIdx][valueIdx];
				});
			});
