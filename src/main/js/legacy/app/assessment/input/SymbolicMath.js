...
module.exports = exports = Ext.define(
	'NextThought.app.assessment.input.SymbolicMath',
	{
		...
		spanTpl: Ext.DomHelper.createTemplate({
			tag: 'span',
			cls: 'tabable',
		}).compile(),
		...
		toolbarTpl: Ext.DomHelper.markup([
			{
				...
				'data-latex': '\\\\surd',
				'data-qtip':
					'{{{NextThought.view.assessment.input.SymbolicMath.insert-sqrt}}}',
			},
			{
				cls: 'mathsymbol square',
				'data-latex': 'x^2',
				'data-qtip':
					'{{{NextThought.view.assessment.input.SymbolicMath.insert-sqr}}}',
			},
			{
				cls: 'mathsymbol parens',
				'data-latex': '(x)',
				'data-qtip':
					'{{{NextThought.view.assessment.input.SymbolicMath.insert-paren}}}',
			},
			{
				cls: 'mathsymbol approx',
				'data-latex': '\\\\approx',
				'data-qtip':
					'{{{NextThought.view.assessment.input.SymbolicMath.insert-approx}}}',
			},
			{
				cls: 'mathsymbol pi',
				'data-latex': '\\\\pi',
				'data-qtip':
					'{{{NextThought.view.assessment.input.SymbolicMath.insert-pi}}}',
			},
			{
				cls: 'mathsymbol leq',
				'data-latex': '\\\\leq',
				'data-qtip': 'Insert less than or equal to',
			},
			{
				cls: 'mathsymbol geq',
				'data-latex': '\\\\geq',
				'data-qtip': 'Insert greater than or equal to',
			},
			{
				cls: 'mathsymbol neq',
				'data-latex': '\\\\neq',
				'data-qtip': 'Insert not Equal',
			},
		]),
		...
		afterRender: function () {
			...
			var s = (this.mathquillSpan = this.spanTpl.insertAfter(
				this.inputField
			));
		...
		mathSymbolClicked: function (e) {
			...
			var t = e.getTarget();
			jQuery(this.mathquillSpan).mathquill(
				'write',
				t.getAttribute('data-latex')
			);
