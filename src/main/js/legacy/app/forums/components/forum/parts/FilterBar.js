...
module.exports = exports = Ext.define(
	'NextThought.app.forums.components.forum.parts.FilterBar',
	{
				...
				cn: [
					{
						...
						type: 'text',
						placeholder:
							'{{{NextThought.view.forums.forum.parts.FilterBar.searchplaceholder}}}',
						required: 'required',
					},
					{ cls: 'clear' },
				],
		...
		afterRender: function () {
			...
			this.searchKeyPressed = Ext.Function.createBuffered(
		...
		createGroupByMenu: function () {
			var type = this.currentSort,
				items = [
					...
					{
						text: getString(
							'NextThought.view.forums.forum.parts.FilterBar.creation'
						),
						groupBy: 'created',
					...
					{
						text: getString(
							'NextThought.view.forums.forum.parts.FilterBar.comment'
						),
						groupBy: 'comment',
					...
					{
						text: getString(
							'NextThought.view.forums.forum.parts.FilterBar.likes'
						),
						groupBy: 'likes',
						checked: type === 'likes',
					},
