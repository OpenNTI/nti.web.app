...
module.exports = exports = Ext.define('NextThought.app.windows.StateStore', {
	...
	fireReplaceOpenWindowRoute: function (
		object,
		state,
		title,
		route,
	...
	addAllowNavigationHandler: function (fn) {
		if (!this['allow_navigation_handler']) {
			...
			console.error(
				'The window cannot have more than one navigation handler'
			);
		}
	},
	...
	allowNavigation: function () {
		return (
			(this['allow_navigation_handler'] &&
				this['allow_navigation_handler'].call(null)) ||
			false
		);
	},
