	...
	'NextThought.app.MessageBox',
	{
		...
		statics: {
			...
			show: function () {
				...
				this.SHARED_INSTANCE.show.apply(
		...
		getDoNotShowAgainCheckState: function () {
			if (!this.doNotShowCheckbox) {
				return false;
			}

			var dom =
					this.doNotShowCheckbox &&
					this.doNotShowCheckbox.el &&
					this.doNotShowCheckbox.el.dom,
