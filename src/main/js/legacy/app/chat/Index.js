		...
		Ext.define('NextThought.app.chat.Index', {
			...
			initComponent: function () {
				...
				this.mon(this.ChatStore, {
					...
					'show-all-gutter-contacts':
						this.showAllOnlineContacts.bind(this),
					'hide-all-gutter-contacts':
						this.hideAllOnlineContacts.bind(this),
			...
			showCalendarWindow: function (gutter) {
				...
				if (this.showingCalendar) {
					...
					this.calendarWin = Ext.widget(
						'gutter-list-calendar-window',
						{
			...
			toggleGutter: function () {
				...
				if (isVisible) {
					...
					var me = this;
					Ext.each(
						this.ChatStore.getAllChatWindows(),
						function (win) {
							if (
								me.gutterWin &&
								me.gutterWin.adjustToExpandedChat &&
