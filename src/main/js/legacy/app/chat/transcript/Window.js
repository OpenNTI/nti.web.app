...
module.exports = exports = Ext.define(
	'NextThought.app.chat.transcript.Window',
	{
		...
		failedToLoadTranscript: function () {
			alert({
				msg:
					'There was an error loading chat history for:' +
					(this.errorMsgSupplement || ''),
				width: 450,
			});
			this.destroy();
		},
		...
		insertTranscript: function (record) {
			...
			var time =
					record.get('RoomInfo').get('CreatedTime') ||
