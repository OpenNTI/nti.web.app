...
module.exports = exports = Ext.define(
	'NextThought.app.chat.components.log.Moderated',
	{
		...
		initComponent: function () {
			Ext.container.Container.prototype.initComponent.apply(
				this,
				arguments
			);
		...
		update: function (m) {
			...
			me.renderData.time = Ext.Date.format(
				m.get('Last Modified'),
				'g:i:sa'
			);
		...
		click: function (event, target, eOpts) {
			...
			if (inBox) {
				...
				var w = Ext.widget('wb-window', {
					height: '75%',
					width: '50%',
					value: this.message.get('body')[0],
					readonly: true,
				});
				w.show();
