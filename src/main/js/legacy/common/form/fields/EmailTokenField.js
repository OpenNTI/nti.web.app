...
module.exports = exports = Ext.define(
	'NextThought.common.form.fields.EmailTokenField',
	{
		...
		addTag(val, type, extraData) {
			...
			if (!Ext.Array.contains(me.getValue(), val)) {
				...
				if (
					...
					this.inputEl.dom.placeholder === 'Add an email address'
				) {
		...
		removeToken: function (p) {
			...
			if (
				...
				this.inputEl.dom.placeholder === 'Add more...'
			) {
