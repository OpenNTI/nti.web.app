Ext.define('NextThought.app.slidedeck.transcript.parts.Transcript', {
	...
	getUserDataTimeFilter: function() {
		function fn(item) {
			var range = item.get('applicableRange'),
				...
				utils = NextThought.app.slidedeck.transcript.AnchorResolver;
	...
	getAnchorResolver: function() {
		return NextThought.app.slidedeck.transcript.AnchorResolver;
	},
