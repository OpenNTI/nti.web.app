Ext.define('NextThought.app.slidedeck.transcript.TranscriptView', {
	...
	requires: [
		...
		'NextThought.app.slidedeck.transcript.NoteOverlay',
		'NextThought.app.slidedeck.transcript.parts.Slide',
