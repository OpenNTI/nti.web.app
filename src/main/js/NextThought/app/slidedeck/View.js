Ext.define('NextThought.app.slidedeck.View', {
	extend: 'Ext.container.Container',
	alias: 'widget.slidedeck-view',
	requires: [
		'NextThought.app.slidedeck.Slide',
		'NextThought.app.slidedeck.Queue',
		'NextThought.app.slidedeck.Video',
		'NextThought.app.slidedeck.transcript.SlideView',
